...
and go down to its layout, with testing on each level. To integrate the cache,
	...
	cache functionality by SystemVerilog simulation. Upon completing functionality verification, cache components are implemented and integrated in Electric, and then their testing methodology is explained. Finally, design quality is tested using SPICE simulations.
\end{abstract}
