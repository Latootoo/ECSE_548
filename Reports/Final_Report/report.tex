...
\ref{lst:asm}. The assembly code load data from off-chip main memory, and some arithmetic manipulations are done. Then the result is written back to the main memory.
